...
--
-- Host: localhost    Database: szatnia
-- ------------------------------------------------------
...
CREATE TABLE `box` (
  ...
  PRIMARY KEY (`id`),
  KEY `room_id` (`room_id`),
  CONSTRAINT `box_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`)
...
CREATE TABLE `item` (
  ...
  PRIMARY KEY (`id`),
  KEY `box_id` (`box_id`),
  CONSTRAINT `item_ibfk_1` FOREIGN KEY (`box_id`) REFERENCES `box` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
